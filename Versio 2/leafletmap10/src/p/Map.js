//tässä versiossa hel4.geojson:ista haetut paikkatiedot, mutta eivät erillisessä tiedostossa
...
class Map extends React.Component
{
  ...
  render()
  {
    ...
    >
      ...
      <GeoJSON data={omadata} style={this.getStyle} onEachFeature={this.onEachFeature}/>
